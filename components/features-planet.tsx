      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            ...
            High volumes of non-disclosure agreements (NDAs) are a given for large investment banks and alternative asset managers.
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              NDAs are legally binding contracts that protect sensitive and proprietary information from being disclosed.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Experience effortless NDA execution with our streamlined process, ensuring smooth communication and efficient implementation for protection of your confidential information.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Seamlessly integrate electronic signatures into your NDAs, allowing for convenient and legally binding agreements. Accelerate the signing process and eliminate the hassle of physical paperwork.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Safely store and organize your NDAs on our secure cloud-based storage. Access your documents anytime, anywhere, with robust security measures ensuring the confidentiality of your data.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Collaboration and Notifications</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Collaborate with other parties involved in the NDA process. Receive real-time notifications for NDA execution on your profile and via email.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Convenient Customization</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Customize your NDA by seamlessly choosing the length of terms, jurisdiction, and other clauses which tailors the NDA to fit your exact needs
              </p>
            </article>
          </div>
        </div>
